 ...
 */
  ...
  using System.Collections.Generic;
    ...
    public class AltPQ<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>> {
      ...
      public AltPQ(int capacity, IComparer<TPriority> comparer) {
        if (comparer == null)
      ...
      /// </summary>
      /// <param name="comparer">priority comparer</param>
      public AltPQ(IComparer<TPriority> comparer) {
        if (comparer == null)
          throw new ArgumentNullException();
      ...
      public AltPQ(IEnumerable<KeyValuePair<TPriority, TValue>> data)
      ...
      /// <param name="data">data to be inserted into priority queue</param>
      /// <param name="comparer">priority comparer</param>
      public AltPQ(IEnumerable<KeyValuePair<TPriority, TValue>> data, IComparer<TPriority> comparer) {
      ...
      /// </remarks>
      public static AltPQ<TPriority, TValue> MergeQueues(AltPQ<TPriority, TValue> pq1, AltPQ<TPriority, TValue> pq2) {
      ...
      /// <returns>resultant priority queue</returns>
      public static AltPQ<TPriority, TValue> MergeQueues(AltPQ<TPriority, TValue> pq1, AltPQ<TPriority, TValue> pq2, IComparer<TPriority> comparer) {
        if (pq1 == null || pq2 == null || comparer == null)
          throw new ArgumentNullException();
        // merge data
        AltPQ<TPriority, TValue> result = new AltPQ<TPriority, TValue>(pq1.Count + pq2.Count, pq1._comparer);
